...
use App\Orchid\Screens\Brands\BrandEditScreen;
use App\Orchid\Screens\Brands\BrandListScreen;
...
//Brand
Route::screen('brand/{brand?}', BrandEditScreen::class)->name('platform.brand.edit');
Route::screen('brands', BrandListScreen::class)->name('platform.brand.list');
